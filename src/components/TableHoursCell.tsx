...
const TableHoursCell = () => {
  ...
  return (
    <td className="border border-y-2">
      ...
      {startTime !== "" && endTime != "" ? (
        <button className="mx-auto flex w-fit cursor-default items-center justify-center rounded px-2 transition-all hover:-translate-y-0.5 hover:shadow-md hover:shadow-sky-900/40 active:translate-y-0 active:bg-sky-400/30">
          <svg
            className="mx-2 size-4 fill-gray-400"
            viewBox="0 0 16 16"
